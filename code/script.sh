...
# devrev snap_in_package delete-one 
devrev_id="gaston.donikian@devrev.ai" # add your email here
echo "Initiating DevRev CLI Authentication for DevRev ID: ${devrev_id}"
# devrev profiles authenticate --env prod --org icici-process-workflow --usr ${devrev_id}
...
name="First SnapIn"
description="This snapin allows creation of new process automation and workflows"
